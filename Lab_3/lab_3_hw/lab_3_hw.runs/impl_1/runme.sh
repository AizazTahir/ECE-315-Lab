...
HD_PWD='C:/Users/matahir/Desktop/ECE-315-Lab/Lab_3/lab_3_hw/lab_3_hw.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_test_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_test_wrapper.tcl -notrace
