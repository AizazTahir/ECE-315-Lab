...
void handleSentEvent()
{
    ...
    BaseType_t xHigherPriorityTaskWoken = pdFALSE;
/*************************** Enter your code here ****************************/
		// TODO 2: increment the receive interrupt counter
		countTxIrq++
/*****************************************************************************/
...
/*************************** Enter your code here ****************************/
		...
		if (xQueueReceiveFromISR(xTxQueue, data, taskToSwitch) == pdPASS) {
...
/*************************** Enter your code here ****************************/
	...
	if (myReceiveData() == pdTRUE) {
		if (xQueueReceive(xRxQueue, &recv, (TickType_t)0) == pdPASS) {
...
/*************************** Enter your code here ****************************/
	...
	if (XUartPs_IsTransmitEmpty(&UART)){
		...
		XUartPs_WriteReg(UART.BaseAddress, XUARTPS_FIFO_OFFSET, (u32)data);
/*****************************************************************************/
